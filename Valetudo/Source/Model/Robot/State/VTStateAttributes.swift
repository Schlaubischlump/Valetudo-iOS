...
public enum VTPresetType: String, Codable {
...
public enum VTPresetValue: String, Codable {
...
public enum VTStatusValue: String, Codable {
...
public enum VTStatusFlag: String, Codable {
    case none, zone, segment, spot, target, resumable, mapping
}

public enum VTDockStatusValue: String, Codable {
...
public enum VTConsumableUnit: String, Codable {
    case percent, minutes
}

public enum VTConsumableType: String, Codable {
    case brush, filter, cleaning, mop, detergent
}

public enum VTConsumableSubType: String, Codable {
    case main, sideRight = "side_right", sensor, all, dock
}

public enum VTAttachmentType: String, Codable {
...
public enum VTBatteryFlag: String, Codable {
    case none, charging, discharging, charged
}

public protocol VTStateAttribute: Decodable & Equatable {
...
public struct VTConsumableRemaining: Codable {
...
public struct VTStateAttributes: Decodable {
...
extension VTStateAttributes: Equatable {
    public static func == (lhs: VTStateAttributes, rhs: VTStateAttributes) -> Bool {
