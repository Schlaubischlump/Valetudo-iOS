//
//  VTRectangularVirtualRestrictionMapOverlay.swift
//  Valetudo
//
...
@MainActor
class VTRectangularVirtualRestrictionMapOverlay: VTMapOverlay {
    ...
    override func makeLayer() -> VTMapOverlayLayer {
        VTRectangularVirtualRestrictionMapOverlayLayer(overlayID: id)
    }

    override func configure(layer: VTMapOverlayLayer) {
        guard let layer = layer as? VTRectangularVirtualRestrictionMapOverlayLayer else {
