...
final class VTSystemInformationViewController: VTSystemInformationViewControllerBase {
    ...
    private func memoryItem(for memory: VTMemory) -> VTSystemInformationItem {
        .segmentedBar(config: .init(
            title: "SYSTEM_MEMORY".localizedCapitalized(),
            bars: [
                [
            ...
            legend: [
                .init(color: .vtGreen,     text: "SYSTEM".localizedCapitalized()),
                .init(color: .vtRed,       text: "VALETUDO".localizedCapitalized()),
                .init(color: .vtTurquoise, text: "VALETUDO_MAX".localizedCapitalized()),
                .init(color: .vtBlue,      text: "FREE".localizedCapitalized())
            ])
        )
    }
    ...
    private func cpuItem(for cpus: [VTCPU]) -> VTSystemInformationItem {
        .segmentedBar(config: .init(
            title: "CPU_USAGE".localizedCapitalized(),
            ...
            legend: [
                .init(color: .vtGreen,     text: "USER".localizedCapitalized()),
                .init(color: .vtTurquoise, text: "NICE".localizedCapitalized()),
                .init(color: .vtRed,       text: "SYS".localizedCapitalized()),
                .init(color: .vtPurple,    text: "IRQ".localizedCapitalized()),
                .init(color: .vtBlue,      text: "IDLE".localizedCapitalized())
            ])
        )
    }
        ...
        for section in sections {
            ...
            case .robot:
                snapshot.appendItems([
                    .keyValuePair(title: "MANUFACTURER".localizedCapitalized(), subtitle: manufacturer),
                    .keyValuePair(title: "MODEL".localizedCapitalized(), subtitle: modelName),
                    .keyValuePair(title: "VALETUDO_IMPLEMENTATION".localizedCapitalized(), subtitle: implementation),
                    .keyValuePair(title: "FIRMWARE".localizedCapitalized(), subtitle: firmwareVersion)
                ], toSection: section)
            case .valetudo:
                snapshot.appendItems([
                    .keyValuePair(title: "RELEASE".localizedCapitalized(), subtitle: release),
                    .keyValuePair(title: "COMMIT".localizedCapitalized(), subtitle: commit),
                    .keyValuePair(title: "EMBEDDED".localizedCapitalized(), subtitle: embedded ? "true" : "false"),
                    .keyValuePair(title: "SYSTEM_ID".localizedCapitalized(), subtitle: systemId)
                ], toSection: section)
            case .host:
                snapshot.appendItems([
                    .keyValuePair(title: "HOSTNAME".localizedCapitalized(), subtitle: hostname),
                    .keyValuePair(title: "ARCH".localizedCapitalized(), subtitle: arch),
                    .keyValuePair(title: "UPTIME".localizedCapitalized(), subtitle: hostUptime),
                    memoryItem(for: memory),
                    cpuItem(for: cpus)
                ], toSection: section)
            case .runtime:
                snapshot.appendItems([
                    .keyValuePair(title: "VALETUDO_UPTIME".localizedCapitalized(), subtitle: valetudoUptime),
                    .keyValuePair(title: "UID".localizedCapitalized(), subtitle: uid),
                    .keyValuePair(title: "GID".localizedCapitalized(), subtitle: gid),
                    .keyValuePair(title: "PID".localizedCapitalized(), subtitle: pid),
                    .keyValuePair(title: "ARGV".localizedCapitalized(), subtitle: argv),
                    .link(title: "DEPENDENCIES".localizedCapitalized(), children: [
                        .main: [
                            .keyValuePair(title: "EXEC_PATH".localizedCapitalized(), subtitle: execPath),
                            .keyValuePair(title: "EXEC_ARGV".localizedCapitalized(), subtitle: execArgv),
                        ],
                        .dependencies: versions.sorted(by: { $0.key < $1.key }).map {
                            .keyValuePair(title: $0, subtitle: $1)
                        }
                    ]),
                    .link(title: "ENVIRONMENT".localizedCapitalized(), children: [
