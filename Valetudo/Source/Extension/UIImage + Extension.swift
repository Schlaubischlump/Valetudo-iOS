...
public extension UIImage {
    static let sidebarHome = UIImage(systemName: "house.fill")
    ...
    static let segmentedCleanup = UIImage(systemName: "rectangle.3.group.fill")
    static let zoneCleanup = UIImage(systemName: "rectangle.ratio.4.to.3")
    static let goToLocation = UIImage(systemName: "mappin.and.ellipse")
    ...
    static let modeSelector = UIImage(systemName: "chevron.down.circle")
