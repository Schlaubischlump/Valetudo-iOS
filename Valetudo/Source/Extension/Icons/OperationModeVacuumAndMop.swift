...
extension UIImage {
  static func svgOperationmodevacuumandmop(size: CGSize = CGSize(width: 24.0, height: 24.0)) -> UIImage {
    let f = UIGraphicsImageRendererFormat.preferred()
    f.opaque = false
    let scale = CGSize(width: size.width / 24.0, height: size.height / 24.0)
    return UIGraphicsImageRenderer(size: size, format: f).image {
      drawOperationmodevacuumandmop(in: $0.cgContext, scale: scale)
    }
  }

  private static func drawOperationmodevacuumandmop(in ctx: CGContext, scale: CGSize) {
    ...
    path.closeSubpath()
    path.move(to: CGPoint(x: 32.11, y: 6.5))
    path.addLine(to: CGPoint(x: 32.11, y: 10.63))
    path.addLine(to: CGPoint(x: 27.99, y: 10.63))
    path.addLine(to: CGPoint(x: 27.99, y: 13.38))
    path.addLine(to: CGPoint(x: 32.11, y: 13.38))
    path.addLine(to: CGPoint(x: 32.11, y: 17.5))
    path.addLine(to: CGPoint(x: 34.86, y: 17.5))
    path.addLine(to: CGPoint(x: 34.86, y: 13.38))
    path.addLine(to: CGPoint(x: 38.99, y: 13.38))
    path.addLine(to: CGPoint(x: 38.99, y: 10.63))
    path.addLine(to: CGPoint(x: 34.86, y: 10.63))
    path.addLine(to: CGPoint(x: 34.86, y: 6.5))
    path.addLine(to: CGPoint(x: 32.11, y: 6.5))
    path.closeSubpath()
